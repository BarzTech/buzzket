// Lightweight client-readable auth flag. The AuthProvider keeps this in sync
// with the real Supabase session (or the dev fallback). Route guards read it
// synchronously without needing the async Supabase client.
