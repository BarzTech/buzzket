...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "Buzzket" },
      { name: "description", content: "Uganda&apos;s home for events, festivals and unforgettable nights." },
      { name: "author", content: "Buzzket" },
      { property: "og:title", content: "Buzzket" },
      { property: "og:description", content: "Find and buy tickets for the best events in Kampala and across Uganda." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@buzzket" },
    ],
    links: [
      {
        rel: "stylesheet",
