      ...
      <section className="relative overflow-hidden bg-primary text-primary-foreground">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 md:py-32">
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault();
              navigate({ to: "/browse", search: { q: search } });
            }}
            className="mt-8 flex max-w-xl items-center gap-2 rounded-2xl bg-primary-foreground p-2 shadow-2xl"
          >
            ...
            <Button type="submit" className="bg-cta text-cta-foreground hover:bg-cta/90 font-semibold rounded-xl px-6">
              Search
            </Button>
          </form>
        </div>
